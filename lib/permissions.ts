...
export const FEATURES: FeatureDef[] = [
  ...
  { key: 'games', href: '/games', group: 'main', label: { es: 'Juegos', en: 'Games' }, hint: { es: 'Lista de juegos y resultados. Editar = cambiar datos del juego', en: 'Games list and results. Edit = change game details' } },
  ...
  { key: 'gamesCreate', group: 'actions', label: { es: 'Crear juegos', en: 'Create games' }, hint: { es: 'Programar juegos entre los equipos de la liga (directiva). Un coach no crea juegos', en: 'Schedule games between the league teams (board). A coach does not create games' } },
  { key: 'gamesLineups', group: 'actions', label: { es: 'Preparar alineaciones', en: 'Prepare lineups' }, hint: { es: 'Elegir alineaciones y quién batea primero antes del juego (coach)', en: 'Pick the lineups and who bats first before the game (coach)' } },
  { key: 'gamesDelete', group: 'actions', label: { es: 'Borrar datos de juego', en: 'Clear game data' }, hint: { es: 'Borrar los turnos y la anotación de un juego', en: "Wipe a game's at-bats and scoring" } },
